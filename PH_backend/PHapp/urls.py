...
urlpatterns = [
	...
	path('solutions/meta/', views.showSolutionMeta),
	path('solutions/<int:act>/<int:scene>/', lambda req, act, scene: redirect(views.showSolution, act=IntToRoman(act), scene=scene, puzzleName='Placeholder', permanent=True)),
	path('solutions/<int:act>/S/', lambda req, act, scene: redirect(views.showSolutionMiniMeta, act=IntToRoman(act), puzzleName='Placeholder', permanent=True)),
	path('solutions/<str:act>/<int:scene>/', views.showSolution),
	path('solutions/<str:act>/S/', views.showSolutionMiniMeta),
