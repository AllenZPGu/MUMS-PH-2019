...
urlpatterns = [
	...
	path('solution/meta/', views.showSolutionMeta),
	path('solution/<int:act>/<int:scene>/', lambda req, act, scene: redirect(views.showSolution, act=IntToRoman(act), scene=scene, puzzleName='Placeholder', permanent=True)),
	path('solution/<int:act>/S/', lambda req, act, scene: redirect(views.showSolutionMiniMeta, act=IntToRoman(act), puzzleName='Placeholder', permanent=True)),
	path('solution/<str:act>/<int:scene>/', views.showSolution),
	path('solution/<str:act>/S/', views.showSolutionMiniMeta),
